                ...
                >
                    <div className="flex items-start space-x-4">
                        {project.logo ? (
                            ...
                            <div
                                className="w-16 h-16 rounded-lg bg-gray-100 dark:bg-gray-700 
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-xs text-gray-400 dark:text-gray-500">{new Date(project.createdAt).toLocaleDateString()}</p>
                        </div>
                    </div>
                </button>
            ))}
