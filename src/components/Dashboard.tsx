        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
                <div className="flex items-start space-x-6">
                    {project.logo ? (
                        <img src={project.logo} alt={project.name} className="w-24 h-24 rounded-lg object-cover" />
                    ) : (
                        <div className={clsx("w-24 h-24 rounded-lg flex items-center justify-center", getTypeColor())}>
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-gray-500 dark:text-gray-500">Created {new Date(project.createdAt).toLocaleDateString()}</p>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-3xl font-semibold text-gray-900 dark:text-white">{stats.successRate}%</p>
                        </div>
