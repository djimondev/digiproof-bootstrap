...
import { Archive, ChevronDown, Clock, Shield } from "lucide-react";
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                <span className="font-medium text-gray-900 dark:text-white">{currentApp}</span>
                <ChevronDown size={20} className={clsx("transform transition-transform text-gray-500 dark:text-gray-400", isOpen ? "rotate-180" : "")} />
            </button>
